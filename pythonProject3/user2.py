...
class travel(Toplevel):
    ...
    def __init__(self):
        ...
        self.title("Cool Cab Booking System")
        ...
        def iExit():
            iExit = ms.askyesno("Prompt!", "Do you want to exit?", parent=self)
            if iExit > 0:
                self.destroy()
                return
            ...
            if varl1.get() != varl2.get() :
                ...
                try:
                    ...
                    if pqr == '':
                        ...
                        print(int(pqr))
                    if len(Mobile.get()) == 10 and len(Email.get()) >= 5 and len(Address.get()) >= 3 and len(
                            Postcode.get()) == 6 and (len(Telephone.get()) == 11 or Telephone.get() == ''):
                        if reset_counter == 0 and Firstname.get() != "" and Surname.get() != "" and Address.get() != "" and Postcode.get() != "" and Mobile.get() != "" and Email.get() != "":
                            self.txtReceipt1.delete("1.0", END)
                            self.txtReceipt2.delete("1.0", END)
                        ...
                        ms.showerror('Oops!', 'enter valid entries...', parent=self)
                except Exception as e:
                    ms.showerror('Oops!', 'enter valid entries...', parent=self)

            else:
                ms.showerror('Oops!','Select different drop location', parent=self)
        ...
        self.lblTitle = Label(Tops, font=('lucida console', 65, 'bold'), text=" \n Cool Cab Booking System ", fg="#402318")
        self.lblTitle.grid()
        ...
        self.txtReceipt1 = Text(ReceiptFrame, width=22, height=21, font=('Courier', 10, 'bold'), borderwidth=0)
        self.txtReceipt1.grid(row=0, column=0, columnspan=2)
        self.txtReceipt2 = Text(ReceiptFrame, width=22, height=21, font=('Courier', 10, 'bold'), borderwidth=0)
